	...
	$('#state').change(function () {
		...
		$("#email").blur(function(){
			var owner_email = $("#email").val();
				 $.ajax({
				  type: "POST",
				  url: "<?php echo base_url();?>manage/dashboard/email_checking_msme",
		...
		$("#mob_no").blur(function(){
				 ...
				 $.ajax({
				  type: "POST",
				  url: "<?php echo base_url();?>manage/dashboard/mobile_checking_msme",
				  data: { mob_no: mob_no},
		...
		$("#pan_firm").blur(function(){
			var pan_firm = $(this).val();
				 $.ajax({
				  type: "POST",
				  url: "<?php echo base_url();?>manage/dashboard/pan_checking_msme",
		...
		$('#mob_no,#landline_no,#pincode,#turnover').on('keyup blur input',function(){	
				var name=$(this).val();
				name=name.replace(/[^0-9]+/g, '');
				$(this).val(name);
				});
				
				$('#enterprise_name,#owner_name').on('keyup',function(){	
					var name=$(this).val();
				...
				$('#pan_firm').on("keyup input",function(){
...
<?php if(isset($msg)){ echo $msg; }?>
      <form id="hold_frm" method="post" action="<?php echo base_url();?>manage/dashboard/save_msme" class="div-margin">
        ...
        <!--<div class="clear"></div>-->
		<div class="col-lg-6">PAN of Firm: <span class="star">*</span><br><input type="text" style="text-transform: uppercase" maxlength="10" onblur="fnValidatePAN(this);" name="pan_firm" id="pan_firm" value="<?php echo set_value('pan_firm'); ?>" class="module-input"><span id="span_pan"></span>
        ...
        <!--<div class="clear"></div>-->
		<span id="pan_exists" style="position:relative;top:4px;"></span>
		<div class="col-lg-6">Address Line 1: <span class="star">*</span><br><input type="text" name="address1" id="address1" value="<?php echo set_value('address1'); ?>" class="module-input">
		...
		<div class="col-lg-6">Address Line 2:<br><input type="text" name="address2" id="address2" value="" class="module-input"></div>
        <!--<div class="clear"></div>-->
        ...
        <!--<div class="clear"></div>-->
		<div class="col-lg-6">Landline Number:<br><input type="text" maxlength="11" name="landline_no" id="landline_no" value="" class="module-input"></div>
		<!--<div id="mob_no_msme" style="color:blue;"></div>-->
		 <div class="clear"></div>
		 <span style="position:relative;top:4px;" class="pull-left" id="mob_no_msme"></span>
		<div class="col-lg-6">Latest Audited Turnover: <span class="star">*</span><br><input type="text" name="latest_audited_turnover" id="turnover" value="<?php echo set_value('latest_audited_turnover'); ?>" placeholder="Rs. in Lacs" class="module-input">(Rs. in Lacs)
		<span  class="requirederror alert alert-success alrt_md"><?php echo form_error('latest_audited_turnover'); ?></span>
		</div>
        <!--<div class="clear"></div>-->
		<!--<div class="col-lg-6">Select Password: <span class="star">*</span><br><input type="password" id="new_password" name="password" class="module-input"></div>
		<div class="col-lg-6">Confirm Password: <span class="star">*</span><br><input type="password" id="con_password" name="con_password" class="module-input"></div>-->
        <div class="clear"></div>
