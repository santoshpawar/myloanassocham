...
class pdftk
{
    ...
    //StartConfiguration
   // protected $sBin = 'd:/xampp/htdocs/tristar/application/third_party/tk/pdftk';
	public $sBin = '';
    ...
    {
		 $this->sBin = realpath(dirname('uploads')).DIRECTORY_SEPARATOR.'application'.DIRECTORY_SEPARATOR.'third_party'.DIRECTORY_SEPARATOR.'tk'.DIRECTORY_SEPARATOR.'pdftk';
    ...
    public function _renderPdf()
    {
		...
		echo "<pre>";print_r($sContent);echo "<pre>";
    ...
    protected function _exec($sCommand, $sInput = null)
    {
        ...
        $proc = exec($sCommand, $aDescriptorSpec, $aPipes);
echo "<pre>";print_r($sCommand);echo "<pre>";die();
