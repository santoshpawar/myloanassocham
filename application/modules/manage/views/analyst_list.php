...
<div class="row">
    <form role="form" class="div-margin line-height40">
		<div class="col-sm-3">Analyst <span  class="application-counter"><?php echo count($analyst_list);?></span></div>
		<div class="col-sm-6"></div>
		<div class="col-sm-3"><button type="button" id="add_analyst" class="yellow-button new_loan_mp"><strong>ADD NEW ANALYST</strong></button>
        </div>
        <div class="clear"></div>
    ...
    <thead>
      <tr class="dark-row">
        ...
        <th class="text-center nosort">Analyst Name
        <br class="clear">
        <div class="text-center up-down-arrows"><span class="arrow-up"></span><span class="arrow-down"></span></div>
        </th>
	...
	<tfoot style="display:table-row-group;">
      <tr class="filterthd">
        ...
        <th class="fltcl text-center">Analyst Name
        </th>
    ...
    <tbody>
  	  <?php  
	  $i=1;
	  foreach($analyst_list as $row){?>
                             
      <tr>
        <td><?php echo "#".$i?></td>
        <td><?php echo $row['analyst_name'];?></td>
        <td><?php echo $row['analyst_email'];?></td>
		<td class="edit-delete-icons"><a href="<?php echo base_url();?>manage/dashboard/edit_users/<?php echo base64_encode('3');?>/<?php echo base64_encode($row['id']);?> " title="Edit"><i class="fa fa-pencil right-margin10"></i></a><a id="del" href="<?php echo base_url();?>manage/dashboard/delete_user/<?php echo base64_encode('3');?>/<?php echo base64_encode($row['id']);?>" title="Delete"><i class="fa fa-close"></i></a></td>
      </tr>
	  <?php $i++; } ?>  
    </tbody>
  </table>
