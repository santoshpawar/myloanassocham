...
$(document).ready(function() {
    ...
    // DataTable
    var table = $('#DataTable1').DataTable({"aaSorting": [], "columnDefs": [{ "orderable": false, "targets": [3, 4,5] }]});
...
input{
 ...
 <div class="row">
    <form role="form" class="div-margin line-height40">
		...
		<?php if($utype_id!=3){?>
		<div class="col-sm-3"><button type="button" class="yellow-button new_loan_mp" id="new_loan"><strong>NEW LOAN APPLICATION	</strong></button>
        </div>
		<?php } ?>
        <div class="clear"></div>
    ...
    <thead>
      <tr class="head_text">
        ...
        <th class="text-center nosort">Type of Facility
        <br>
        <div class="text-center up-down-arrows"><span class="arrow-up"></span><span class="arrow-down"></span></div>
        </th>
	...
	<tr class="filterthd">
        ...
        <th class="fltcl text-center">Type of Facility
         </th>
				...
				<div class="modal-content">
				  <div class="modal-header">
					...
					<h5 class="red-text">Application Status of #<?php echo $row['application_id'];?></h5>
					 ...
					 <div class="modal-body mdy">
						<table class="table">
							<tbody>				
								<tr class="appst">
									<td align="left"><div class="app_st">Application Status:</div></td>
									<td align="right"><div class="status-option approved"></div></td>
								</tr>
							</tbody>
							<tbody class="bnknm">
							</tbody>
