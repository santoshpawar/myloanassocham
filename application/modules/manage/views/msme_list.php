...
<div class="row">
	...
	<tfoot style="display:table-row-group;">
      <tr class="filterthd">
		...
		<th class="fltcl text-center">Channel Partner</th>
    ...
    <tbody>
	  ...
	  foreach($msme_list as $row){?>
		...
		<td class="edit-delete-icons"><a href="<?php echo base_url();?>manage/dashboard/edit_users/<?php echo base64_encode('1');?>/<?php echo base64_encode($row['msmeid']);?>" title="Edit"><i class="fa fa-pencil right-margin10"></i></a><a id="del" href="<?php echo base_url();?>manage/dashboard/delete_user/<?php echo base64_encode('1');?>/<?php echo base64_encode($row['msmeid']);?>" title="Delete"><i class="fa fa-close"></i></a></td>
      </tr>
	  <?php $i++;}?>
    </tbody>
  </table>
