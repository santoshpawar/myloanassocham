...
class PHPMailer {
   ...
   * @var string
   */
  //public $From              = 'arya.ray@wiantech.com';
  public $From             	  = 'wianamit@gmail.com';
   ...
   * @var string
   */
 // public $Username      = 'arya.ray@wiantech.com';
   public $Username      = 'AKIAJ2G77VOUZI6RESOA';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'ApO0qdm6teQqUqym2LuQEm9n63pxXqvEEttJcWrBGk9Z';
 // public $Password      = 'Rary12ay';
  ...
  protected function SmtpSend($header, $body) {
    ...
    require_once  'application/helpers/PHPMailer/' . 'class.smtp.php';
    $bad_rcpt = array();
